...
| `MiaAI-Lab/GLM-5.3-Flash-EXL3-2x-DGX-Sparks` and `FlyCockpit/GLM-5.3-Flash-EXL3-3x-DGX-Sparks` (prior art) | see [CREDITS.md](CREDITS.md) | **MIT**, both confirmed | We vendor **no files** from either. What we took is practice and arithmetic, and we say which. If you copy their files rather than their ideas, read their licences first. |
